...
```bash
workflow-data.py list-run-timing rbwatson to-do-service-au26
```
...
```bash
workflow-data.py get-run-timing rbwatson to-do-service-au26 12345678
```
...
workflow-data.py list-run-timing rbwatson to-do-service-au26 --days 1

# Test get command (requires valid run ID)
workflow-data.py get-run-timing rbwatson to-do-service-au26 <run-id>
