...
| --------- | ---------- | --------- | ----------- |
| **File location** |
| Files modified outside allowed directories (non-admin user) | Error | Students can only modify files in `/docs/` and `/assignments/`. | <https://github.com/UWC2-APIDOC/to-do-service-au26/wiki/File-Locations> |
| **Filename** |
| Filename contains unsafe characters | Error | Found N unsafe filenames in changed-files list | None |
| **Commit structure** |
| Branch not up to date | Warning | Pull request branch not up to date. Consider rebasing. | <https://github.com/UWC2-APIDOC/to-do-service-au26/wiki/Updating-Your-Branch> |
| Multiple commits in Pull request | Error | Pull request must contain exactly one commit; found N | <https://github.com/UWC2-APIDOC/to-do-service-au26/wiki/Squashing-Commits> |
| Pull request contains merge commits | Error | Pull request contains merge commits; found N | <https://github.com/UWC2-APIDOC/to-do-service-au26/wiki/Avoiding-Merge-Commits> |
| **Front matter** |
...
| **API examples** |
| Example not found or malformed | Warning | Couldn't find example '\[name\]' or it's not formatted correctly | <https://github.com/UWC2-APIDOC/to-do-service-au26/wiki/Example-Format> |
...
| Response section not found | Warning | Couldn't find documented response for '\[name\]' or it's not formatted correctly | <https://github.com/UWC2-APIDOC/to-do-service-au26/wiki/Example-Format> |
...
```text
Help: https://github.com/UWC2-APIDOC/to-do-service-au26/wiki/Squashing-Commits
```
